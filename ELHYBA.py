...
ownerID = int("6534175982") #ايدي الادمن 
...
bot = Client(
  'bot'+token.split(":")[0],
  27114545, #ايبي ايدي
 '4d697dc98a6c882527aab3f72b25479d', #ايبي هاش
...
async def generator_and_about(app,m):
    if m.text == "مـعـلـومـات عـن الـبـوت":
      ...
      text += f"\n\n👤 مـطـوريـن الـبـوت: [**المطورين**](https://t.me/vip_vad/103)"
...
app.start()
bot.start()
print("تم تشغيل البوت @tromix_refz_bot")
idle()
